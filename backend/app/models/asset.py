...
class Asset(Base):
    ...
    symbol = Column(String, unique=True, index=True, nullable=False) # e.g., AAPL, BTCUSD
    name = Column(String, index=True) # e.g., Apple Inc., Bitcoin
    asset_type = Column(SAEnum(AssetType), nullable=False, index=True) # stock or crypto
